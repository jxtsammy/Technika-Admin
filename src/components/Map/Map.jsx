        ...
        const load = async () => {
            try {
                ...
                setTechnicians(
                    techs
                        .filter(
                            (t) => t.location && t.location.latitude != null,
                        )
                        .map((t) => ({
                            id: t._id,
                            name: fullName(t),
            ...
            <div className="map-sidebar">
                ...
                <div className="advanced-filter-bar">
                    ...
                    <span className="filter-label">
                        Max Distance: <strong>{maxDistance}m</strong>
                    </span>
                    <input
                        type="range"
                        min="500"
                        ...
                        filteredTechnicians.map((tech) => (
                            ...
                            >
                                ...
                                <div className="tech-card-right">
                                    <span
                                        className={`status-badge-dot ${tech.status}`}
                                    ></span>
                            ...
                            <Popup>
                                ...
                                >
                                    ...
                                    {tech.locationUpdatedAt &&
                                        ` · updated ${new Date(tech.locationUpdatedAt).toLocaleTimeString()}`}
                                </span>
                            </Popup>
                        </Marker>
                    ))}
